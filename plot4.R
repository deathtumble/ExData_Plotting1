...
plot(household$Global_active_power ~ household$DateTime, xaxt = "n", type = "l", ylab = "Global Active Power (kilowatts)", xlab = "")
axis(1, at = as.POSIXct(as.Date(axisValues)) , format(axisValues, "%a"))

plot(household$Voltage ~ household$DateTime, xaxt = "n", type = "l", ylab = "Global Active Power (kilowatts)", xlab = "datetime")
axis(1, at = as.POSIXct(as.Date(axisValues)) , format(axisValues, "%a"))
...
plot(household$Global_reactive_power ~ household$DateTime, xaxt = "n", type = "l", ylab = "Global_reactive_power", xlab = "datetime")
axis(1, at = as.POSIXct(as.Date(axisValues)) , format(axisValues, "%a"))
